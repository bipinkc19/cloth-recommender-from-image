...
image, label = DataLoad('../drive/My Drive/data_test.tfrecords', 128, EPOCHS, BATCHSIZE).return_dataset()
val_image, val_label = DataLoad('../drive/My Drive/data_test.tfrecords', 128, EPOCHS, BATCHSIZE).return_dataset()
